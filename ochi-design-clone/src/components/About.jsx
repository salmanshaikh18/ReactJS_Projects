...
const About = () => {
  return (
    <div className='w-full px-10 py-20 bg-[#CDEA68] rounded-tl-3xl rounded-tr-3xl text-black'>
        <h1 className='text-5xl w-[80vw]'>Ochi is a strategic partner for fast-growing tech businesses that need to raise funds, sell products, explain complex ideas, and hire great people.</h1>
        <div className='w-full border-t-[2px] border-[#738d15] mt-20 flex gap-5'>
            <div className='w-1/2 mt-5'>
                <h1 className='text-6xl mb-3'>Our approach:</h1>
                <button className='flex justify-center items-center gap-5 px-5 py-4 bg-zinc-900 rounded-full text-white'>Read More
